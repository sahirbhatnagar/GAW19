#!/bin/bash
# this is the same as makepdtctrl.sh except this is for best imputed and seq people

echo "#first line is a comment, it must begin with #
#file that contains genotypes
pedigree_file:                         chr$1/FBAT$1best.ped
...
outfile_by_pvalue:                   chr$1/pdt$1best_pvalue.out
# Result file, sorted by marker
outfile_by_marker:                     chr$1/pdt$1best_marker.out
